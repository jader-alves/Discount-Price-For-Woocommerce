                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="number" name="new_wqrdiscount[]">
                                                    </td>
                                                    <td>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="number" name="new_wqrdiscount[]" value="<?php echo $wqrdiscount[$key]; ?>">
                                                        </td>
                                                        <td>
                                                            <?php $mam_roles = get_editable_roles(); ?>
                                                            <select name="new_wqr_roles[][]" id="wqr_roles" multiple>
